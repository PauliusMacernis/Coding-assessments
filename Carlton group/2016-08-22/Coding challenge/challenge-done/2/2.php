 ...
 * @return object|null
 */
function getHeadOfHierarchy($tree, $nameOfHeadDepartment = null)
{
    if (isset($nameOfHeadDepartment)) {
        return getDepartmentByName($tree, $nameOfHeadDepartment);
    }

    // Get & return head of hierarchy = the top most in hierarchy
    // ...

}

/**
 * Returns member of the tree by name
 * Important! We return the first matching department only.
 *
 * @param $tree array of objects
 *
 * @return object|null
 */
function getDepartmentByName($tree, $nameOfHeadDepartment = null)
{
...
$tree = getHierarchy();
$treeTop = getHeadOfHierarchy($tree, 'IT department');
